...
3. ユーザの発話を基に続きの単語や文章が予測され，ARグラス上に予測結果が薄い白色の文字で表示されます
...
#### アプリをARデバイスと組み合わせて使用する方法
1. ARグラスとiPhoneを接続します
2. A
4. 実際にはARグラス上に予測結果が表示されることで，ユーザは忘れてしまった単語や文法を思い出しスムーズな発話を行うことができます
