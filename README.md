...
初心者以上・ネイティブ未満の英語学習者の会話を視覚的に補助するためのアプリ

### 開発の動機
英会話を補助するアプリは数多く存在しますが，そのほとんどが**翻訳アプリで終わらでしまうものばかり**です。

こういったアプリは英語をほとんど話せないユーザにはありがたいものですが、「ある程度英会話の能力をもっているから**自分の口で、相手の目を見ながら英語を話してコミュニケーションをとりたい！**」と考えている方は多いのではないでしょうか？
