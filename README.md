...
### 解決出来ること
まず「背景」の項で説明した
- 初心者以上・ネイティブ未満の外国語学習者が持っている
- 「学んだ外国語を利用してコミュニケーションしたい」けど
- 「実際の会話で単語や文法がスムーズに出てこない」
- でも「せっかく勉強したのに翻訳アプリにすべて頼って会話するのはもったいない」
...
### 注力したこと（こだわり等）
- 既存の音声認識技術・単語予測技術を複数試行して，本製品にとって速度と精度がバランスよく両立できるようなモデルを選び，アプリに実装したこと
- 市販のARデバイスで使用できることで，本製品の目的であるコミュニケーションのスムーズさを妨害しないで発話の補助を達成していること
