...
### 対象ユーザ
1. 日本人
2. 基本的な単語や文法の知識を持つ初心者以上・ネイティブ未満の英語学習者
3. 実際の英会話において「できるだけ自分の力で話したい」が「スムーズに単語や文法が出てこない」けど「翻訳アプリに頼りきりは嫌だ
」というニーズを持つ
...
2. ユーザ自身が発話すると音声認識され，発話内容が白色の文字で表示されます
...
3. ユーザの発話を基に続きの単語や文章が予測され，ARグラス上に予測結果が白色の文字で透過表示されます
4. ARグラス上に予測結果が表示されることで，ユーザは忘れてしまった単語や文法を思い出しスムーズな発話を行うことができます

![IMG_7924](https://github.com/jphacks/NG_2305/assets/109562639/35ddd113-a542-46d0-9a0f-c078bbbcd8f7)


1. これはXREAL社のairというARグラスを着用している様子です！
...
1. ARグラスとIphoneを接続します。ARグラスの着用時には背景が透過され，文章だけが表示されます!
