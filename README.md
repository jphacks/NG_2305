...
### 背景(製品開発のきっかけ、課題等）
近年、機械翻訳アプリが発達してきていますが、これらのアプリは**どれも英語での会話をアプリだけで終わらでしまうものばかり**です。

こういったアプリは英語をほとんど話せない方々にはありがたいものですが、「ある程度英会話の能力をもっているから**自分の口で、相手の目を見ながら英語を話してコミュニケーションをとりたい！**」と考えている方は多いのではないでしょうか？
...
- もちろんアプリのみでも機能しますが，実際には市販のARグラスを利用することを想定しています！ARグラスの着用時には背景が透過され，文章だけが表示されます!
